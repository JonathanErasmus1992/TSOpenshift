...
@WebAppConfiguration
public class testGetInvoiceService extends AbstractTestNGSpringContextTests{
    @Autowired
    ...
    {
        invoiceid = addInvoiceService.addInvoice(customerid, orderid);
    ...
    {
        invoice = getInvoiceService.getInvoice(invoiceid);
